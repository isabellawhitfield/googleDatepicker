...
var places = [
  {
    ...
    image: "images/skylineWalkway.jpg"
  },
  {
...
function initMap(distance, duration) {
  ...
  for (var i = 0; i < places.length; i++) {
    ...
    // If the place matches both filters then include it
    if (places[i].kilo <= distance && places[i].drive <= duration) {
      // create content dynamically
      var content = '<div class="h4" id="' + places[i].information + '">' +
